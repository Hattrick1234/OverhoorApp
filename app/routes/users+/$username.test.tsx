...
test('The user profile when not logged in as self', async () => {
	...
	await screen.findByRole('link', { name: `${user.name}'s notities` })
})
...
test('The user profile when logged in as self', async () => {
	...
	await screen.findByRole('link', { name: /mijn notities/i })
	await screen.findByRole('link', { name: /wijzig profiel/i })
})
